...
_RUBRO_OSM = {
    ...
    # ─── Rubros de distribuidores (prospección) ───
    "firmas contables": ["office=accountant", "office=accounting", "office=auditor"],
    "firma contable": ["office=accountant", "office=accounting", "office=auditor"],
    "contadores": ["office=accountant", "office=accounting", "office=auditor"],
    "contador": ["office=accountant", "office=accounting"],
    "contab": ["office=accountant", "office=accounting", "office=auditor"],
    "auditoria": ["office=accountant", "office=auditor"],
    "soporte ti": ["office=it", "office=information_technology", "office=telecommunication", "office=technology"],
    "soporte": ["office=it", "office=information_technology", "office=telecommunication"],
    "ti": ["office=it", "office=information_technology"],
    "informatic": ["office=it", "office=information_technology", "office=telecommunication"],
    "computacion": ["office=it", "office=information_technology", "shop=computer"],
    "integradores pos": ["office=it", "shop=computer", "shop=electronics", "office=telecommunication"],
    "punto de venta": ["shop=computer", "office=it", "shop=electronics"],
    "facturacion": ["office=it", "shop=computer", "office=accountant"],
    "facturación": ["office=it", "shop=computer", "office=accountant"],
    "consultores fiscales": ["office=accountant", "office=consulting", "office=adviser"],
    "consultoria fiscal": ["office=accountant", "office=consulting", "office=adviser"],
    "fiscal": ["office=accountant", "office=consulting", "office=adviser"],
    "tributar": ["office=accountant", "office=consulting", "office=adviser"],
    "consultoria": ["office=consulting", "office=adviser", "office=accountant"],
    "consultor": ["office=consulting", "office=adviser"],
    "revendedores erp": ["office=it", "office=consulting", "office=information_technology"],
    "revendedores": ["office=it", "office=consulting"],
    "erp": ["office=it", "office=consulting", "office=information_technology"],
    "implementadores": ["office=it", "office=consulting", "office=information_technology"],
    "software": ["office=it", "office=information_technology", "office=consulting"],
}
